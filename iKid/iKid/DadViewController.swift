...
class DadViewController: UIViewController {
    private var first: DadFirstViewController!
    private var second: DadSecondViewController!
    
    private func firstBuilder() {
        if first == nil {
            first = storyboard?.instantiateViewController(withIdentifier: "DadFirst")as! DadFirstViewController
        }
    }
    private func secondBuilder() {
        if second == nil {
            second = storyboard?.instantiateViewController(withIdentifier: "DadSecond") as! DadSecondViewController
        }
    }
